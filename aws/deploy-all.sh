...
echo "     kubectl get service eduscheduler-frontend"
echo "     Use the EXTERNAL-IP from the output (will be assigned by minikube tunnel)"
echo ""
echo "  3. Or use minikube service (automatically creates tunnel):"
echo "     minikube service eduscheduler-frontend"
echo ""
