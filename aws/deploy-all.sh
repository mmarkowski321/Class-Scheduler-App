...
echo "  1. Start minikube tunnel (required for LoadBalancer services):"
echo "     ./start-minikube-tunnel.sh"
echo "     OR manually: minikube tunnel"
echo ""
echo "  2. Wait for service to get EXTERNAL-IP:"
echo "     kubectl get svc eduscheduler-frontend"
echo ""
echo "  3. Get your EC2 public IP:"
echo "     curl -s http://169.254.169.254/latest/meta-data/public-ipv4"
echo ""
echo "  4. Access frontend via:"
echo "     http://<EC2_PUBLIC_IP>:80"
echo ""
echo "  5. Make sure Security Group allows inbound traffic on port 80"
echo ""
echo "Note: minikube tunnel must be running for LoadBalancer services to work"
echo ""
